...
// d) Na cópia do objeto original, ou seja, no objeto que representa o **Squirtle**, adicione a propriedade **`ataques`**
// a partir do **espalhamento** da propriedade de mesmo nome criada para o objeto original.
pokemon1Copy.ataques = [...pokemon1.ataques];

// e) Para o objeto original, adicione no array de `ataques` o seguinte ataque: **“Folha Navalha”**, com **45 de dano**, 
// **100 de precisão**, e do tipo **“Grama”**.
...
pokemon1Copy.ataques.push(ataque3);
